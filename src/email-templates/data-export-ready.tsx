...
const WARNING_FOREGROUND = "#9a3412";
        ...
        >
          ...
          <Section style={{ padding: "28px 32px 8px 32px" }}>
            ...
            >
              ...
              processing and is ready to download. The link below is unique to
              your account — please don't share it with anyone else.
            </Text>
          </Section>
          ...
          <Section style={{ padding: "16px 32px 8px 32px" }}>
            ...
            >
              ...
              >
                ...
                stop working after the expiration time. Request a new export
                from your account settings if you need access again.
              </Text>
            </div>
          </Section>
          ...
          <Section style={{ padding: "20px 32px 28px 32px" }}>
            ...
            >
              Didn't request a data export? Your account may have been
              accessed by someone else — reset your password and contact us
              right away at{" "}
              <a
...
DataExportReadyEmail.PreviewProps = {
  ...
  expiresAt: "Jul 04, 2026 17:00 UTC",
  fileSize: "12.4 MB",
  fileFormat: "ZIP archive (JSON + CSV)",
  requestedAt: "Jun 27, 2026 14:21 UTC",
  itemSummary:
    "47 schemas across 12 vaults, 3 API keys (metadata only), 218 audit log entries, and account profile.",
