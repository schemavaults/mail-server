...
export default function DataExportReadyEmail(
  ...
  const previewText = `Your ${exportType} from ${productName} is ready to download.`;

  const metaRows: Array<[string, string]> = [];
  if (fileFormat) metaRows.push(["Format", fileFormat]);
  if (fileSize) metaRows.push(["Size", fileSize]);
  if (recordCount) metaRows.push(["Records", recordCount]);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Your {exportType} is ready to download.
            </Heading>
          </Section>
          ...
          <Section style={{ padding: "28px 32px 8px 32px" }}>
            ...
            >
              We've finished preparing the {exportType} you requested from{" "}
              {productName}. Use the button below to download it before the
              link expires.
            </Text>
          </Section>
          ...
          <Section style={{ padding: "16px 32px 0 32px" }}>
            ...
            >
              ...
              >
                <strong style={{ color: SUCCESS_GREEN }}>Ready</strong> — your
                archive has been generated and is available at the secure
                download link below.
              </Text>
            </div>
          </Section>
          ...
          <Section style={{ padding: "20px 32px 28px 32px" }}>
            ...
            >
              For your security, this download link expires on{" "}
            ...
            >
              Didn't request this export? Please contact us at{" "}
              <a
              ...
              right away — someone may be using your account.
            </Text>
          </Section>
        </Container>
...
DataExportReadyEmail.PreviewProps = {
  ...
  expiresAt: "May 17, 2026 17:00 UTC",
  exportType: "Schemas & metadata bundle",
  fileFormat: "ZIP archive",
  fileSize: "12.4 MB",
  recordCount: "1,247 schemas across 18 vaults",
  requestedAt: "May 10, 2026 09:14 UTC",
